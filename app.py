...
year_min = st.sidebar.selectbox("Start Year", all_years, index=0)
year_max = st.sidebar.selectbox("End Year", all_years, index=len(all_years)-1)

# Apply filters 
filtered_df = df[(df['fyear'] >= year_min) & (df['fyear'] <= year_max)]
filtered_df = filtered_df[filtered_df['tic'].isin(companies)]


# ==================== Chart 1: Line Chart (Select Indicator from dropdown menu)====================
...
# ==================== Chart 3: ROE vs ROA Bar Chart (Latest Year) ====================
import plotly.express as px
...
# ==================== Chart 6: Analysis of Stock Returns ====================
import plotly.express as px
...
# ==================== Figure 7: Comprehensive Scorecard ====================
st.header("📋 Company Scorecard")
# ==================== Function 1: Company Ranking Table ====================
# ==================== Key Number Card ====================
...
# ==================== Summary of Investment Suggestions ====================
...
# ==================== Function 2: Year on year change rate  ====================
...
# Select the company with the most improvements
...
# ==================== Function 3: Company Profile Card ====================
st.header("🏢 Company Quick Facts")
